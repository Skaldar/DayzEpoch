...
class_public = [ // These are visible to anyone on the server
    [(localize "str_playerstats_hero")+" Polizist","RU_Policeman_DZ","SurvivorW2_DZ",[START_ITEMS,"17Rnd_9x19_glock17",2],["G17_DZ"],"",[],[],0,5000,0,""],
	[(localize "str_playerstats_hero")+" Pilot","Pilot_EP1_DZ","SurvivorW2_DZ",[START_ITEMS,"17Rnd_9x19_glock17",3,"ItemMorphine"],["G17_DZ"],"DZ_Assault_Pack_EP1",[],[],0,100000,0,""],
	[(localize "str_playerstats_hero")+" Rebell","GUE_Commander_DZ","SurvivorW2_DZ",[START_ITEMS,"17Rnd_9x19_glock17",4,"ItemMorphine"],["G17_DZ"],"DZ_TK_Assault_Pack_EP1",[],[],0,15000,0,"MeleeHatchet"],
	[(localize "str_playerstats_hero")+" Presse",if (class_epoch) then {"Haris_Press_EP1_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS,"6Rnd_45ACP",2],["Revolver_DZ"],"",[],[],0,5000,0,""],
	[(localize "str_playerstats_hero")+" Rocker",if (class_epoch) then {"Rocker1_DZ"} else {"Survivor3_DZ"},"SurvivorW2_DZ",[START_ITEMS,"6Rnd_45ACP",3,"ItemMorphine"],["Revolver_DZ"],"DZ_Assault_Pack_EP1",[],[],0,10000,0,""],
