...
DZMSBanditSkins = ["Bandit1_DZ","BanditW1_DZ","Bandit2_DZ","BanditW2_DZ"];

////////////////////////
// Array of AI Skills
DZMSSkills0 = [
	["aimingAccuracy",0.01,0.012],
