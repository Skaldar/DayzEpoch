...
private ["_disbandButton","_display","_group","_index","_inviteButton","_inviter","_inviterUID","_leader","_leaveButton","_myGroup","_playerList","_promoteButton","_uid"];
...
{_x ctrlShow false;} count [_disbandButton,_inviteButton,_joinButton,_leaveButton,_promoteButton,_rejectButton];
...
while {!isNull findDisplay 80000} do {
    ...
    if (lbSize _myGroup > 1) then {
		...
		{_x ctrlShow false} count [_disbandButton,_leaveButton,_promoteButton];
    };
