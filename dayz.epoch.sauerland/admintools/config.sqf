...
/************** Safe Zone Variables *****************/
	...
	EAT_szAntiTheft = false; // Disable stealing from inventory while in zone (allows interaction with friend inventory)
