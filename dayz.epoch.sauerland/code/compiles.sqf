...
if (!isDedicated) then {
	...
	fnc_usec_selfActions = compile preprocessFileLineNumbers "code\fn_selfActions.sqf"; 		//Checks which actions for self
	...
	player_updateGui = switch (toLower DZE_UI) do {
		...
		//case "epoch": {compile preprocessFileLineNumbers "dayz_code\compile\player_updateGui.sqf";};
